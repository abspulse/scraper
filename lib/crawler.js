...
let queue = []
let events = []
let reCheckInterval = 15 // In minutes
...
// Change reCheckInterval
const setReCheckInterval = (minutes) => {
  reCheckInterval = minutes
}
...
const getQuery = () => ({
  lastChecked: { $lt : minutesAgo(reCheckInterval) },
...
export default { init, getStats, events, setReCheckInterval }
